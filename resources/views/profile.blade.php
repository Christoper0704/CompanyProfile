...
<nav class="navbar navbar-expand-lg navbar-light bg-light shadow fixed-top">
  <div class="container">
    <a class="navbar-brand" href="#home"><img src="{{url('/images/pear.png')}}" alt="Pear Logo" style="width:40px;" class="rounded-pill">PearInc</a>
...
<main>
    ...
    <div class="container">
      <div class="row">
        <div class="col-sm-5 col-md-6"><img src="{{url('/images/visi.jpg')}}" style="width:500px; height:500px"></div>
    ...
    <div class="container">
      <div class="row">
        <div>
          ...
          <div class="col-sm-4">
            <div class="card shadow-lg">
                <img class="card-img-top img-fluid mx-auto d-block mt-2" src="{{url('/images/certificate.png')}}" alt="certificate" style="width:100px; height:100px;">
        ...
        <div class="col-sm-4">
            <div class="card shadow-lg">
            <img class="card-img-top img-fluid mx-auto d-block mt-2" src="{{url('/images/feature.png')}}" alt="feature" style="width:100px; height:100px;">
                <div class="card-block m-3">
        ...
        <div class="col-sm-4">
            <div class="card shadow-lg">
            <img class="card-img-top img-fluid mx-auto d-block mt-2" src="{{url('/images/price.png')}}" alt="harga" style="width:100px; height:100px;">
                <div class="card-block m-3">
    ...
    <div class="container">
      ...
      <div class="row row-cols-1 row-cols-md-2 g-4">
        <div class="col">
          <div class="card">
            <img src="{{url('/images/p10.jpg')}}" class="card-img-top" alt="Pear P10">
            <div class="card-body">
        ...
        <div class="col">
          <div class="card">
            <img src="{{url('/images/advance.jpg')}}" class="card-img-top" alt="Pear Advance">
            <div class="card-body">
        ...
        <div class="col">
          <div class="card">
            <img src="{{url('/images/super.jpg')}}" class="card-img-top" alt="Pear Super" style="height:363px;">
            <div class="card-body">
        ...
        <div class="col">
          <div class="card">
            <img src="{{url('/images/mm3.jpg')}}" class="card-img-top" alt="Pear MM3">
            <div class="card-body">
